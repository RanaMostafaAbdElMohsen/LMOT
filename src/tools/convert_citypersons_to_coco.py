...
DATA_PATH = '/home/rana/Downloads/Cityscapes/'
DATA_FILE_PATH = '/home/rana/Downloads/Cityscapes/citypersons.train'
...
if __name__ == '__main__':
    ...
    for img_path, label_path in zip(img_paths, label_paths):
        image_cnt += 1
        im = Image.open(os.path.join("/home/rana/Downloads", img_path))
        ...
        # Load labels
        if os.path.isfile(os.path.join("/home/rana/Downloads", label_path)):
            labels0 = np.loadtxt(os.path.join("/home/rana/Downloads", label_path), dtype=np.float32).reshape(-1, 6)
